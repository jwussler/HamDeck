@echo off
echo ============================================
echo   HamDeck v3.0 - Build Distribution Package
echo ============================================
echo.
...
if exist "HamDeck-v3.0-dist.zip" del "HamDeck-v3.0-dist.zip"

:: Use PowerShell to create zip
powershell -Command "Compress-Archive -Path '%PUBDIR%\*' -DestinationPath 'HamDeck-v3.0-dist.zip' -Force"

echo.
echo ============================================
echo   Distribution package created:
echo   %CD%\HamDeck-v3.0-dist.zip
echo.
