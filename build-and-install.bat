@echo off
echo ============================================
echo   HamDeck v3.0 - Build and Install
echo ============================================
echo.
...
powershell -Command "$ws = New-Object -ComObject WScript.Shell; $sc = $ws.CreateShortcut('%SHORTCUT%'); $sc.TargetPath = '%EXEPATH%'; $sc.WorkingDirectory = '%WORKDIR%'; $sc.Description = 'HamDeck v3.0'; $sc.Save()"
